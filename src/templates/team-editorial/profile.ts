...
export const team_editorialProfile = defineTemplate({
  ...
  assets: {
    ...
    greetingCards: [
      defineSectionUnderlay(asset("/templates/team-editorial/greeting-card-1.webp", 1200, 500), "adaptive-frame", { safeArea: { x: 0.11, y: 0.13, width: 0.8, height: 0.72 } }),
      defineSectionUnderlay(asset("/templates/team-editorial/greeting-card-2.webp", 1200, 500), "adaptive-frame", { safeArea: { x: 0.11, y: 0.13, width: 0.8, height: 0.72 } }),
      defineSectionUnderlay(asset("/templates/team-editorial/greeting-card-3.webp", 1200, 500), "adaptive-frame", { safeArea: { x: 0.11, y: 0.13, width: 0.8, height: 0.72 } }),
      defineSectionUnderlay(asset("/templates/team-editorial/greeting-card-4.webp", 1200, 500), "adaptive-frame", { safeArea: { x: 0.11, y: 0.13, width: 0.8, height: 0.72 } })
    ],
    ...
    photoFrames: {
      messagePortrait: frame("portrait-shadow-frame", "/templates/team-editorial/photo-frame-portrait-base-v3.webp", "/templates/team-editorial/photo-frame-portrait-overlay-v3.webp", 802, 1122, 0.82),
      messageLandscape: frame("landscape-shadow-frame", "/templates/team-editorial/photo-frame-landscape-base-v3.webp", "/templates/team-editorial/photo-frame-landscape-overlay-v3.webp", 1122, 802, 0.82),
      memory: frame("landscape-shadow-frame-feature", "/templates/team-editorial/photo-frame-memory-base-v2.webp", "/templates/team-editorial/photo-frame-memory-overlay-v2.webp", 1122, 802, 0.82)
    },
    decor: [
      ...
      { id: "hero-right-editorial-desktop", asset: asset("/templates/team-editorial/hero-right-v2.webp", 720, 1080), anchor: "hero", rect: { x: 0.765, y: 0.035, width: 0.34, height: 0.92 }, rotation: 2, opacity: 0.98, visibleOn: ["desktop"] },
      {
        ...
        exportVariants: {
          ...
          post: { rect: { x: -0.05, y: 0.08, width: 0.29, height: 1.35 }, rotation: -2, opacity: 0.99 },
      ...
      },
      {
        ...
        visibleOn: ["export"],
        exportVariants: {
          story: { rect: { x: 0.72, y: 0.04, width: 0.38, height: 0.98 }, rotation: 2, opacity: 0.98 },
          post: { rect: { x: 0.73, y: 0.1, width: 0.36, height: 1.32 }, rotation: 2, opacity: 0.98 },
          a4: { rect: { x: 0.71, y: 0.08, width: 0.38, height: 1.34 }, rotation: 2, opacity: 0.98 }
        }
      },
      { id: "hero-left-editorial-mobile", asset: asset("/templates/team-editorial/hero-left-v2.webp", 720, 1080), anchor: "hero", rect: { x: 0, y: 0.18, width: 0.14, height: 0.28 }, rotation: -3, opacity: 0.96, visibleOn: ["mobile"] },
      { id: "hero-right-editorial-mobile", asset: asset("/templates/team-editorial/hero-right-v2.webp", 720, 1080), anchor: "hero", rect: { x: 0.86, y: 0.18, width: 0.14, height: 0.28 }, rotation: 3, opacity: 0.95, visibleOn: ["mobile"] }
    ]
  },
  typography: {
