...
export const universalTemplateFixtures: Readonly<Record<UniversalTemplateFixtureId, UniversalTemplateFixture>> = {
  ...
  "team-editorial-demo": {
    id: "team-editorial-demo",
    label: "Коллеге — с повышением",
    description: "Егор Дмитриевич, 20 поздравлений, 5 качеств, 3 лучшие фразы, 3 фото поздравлений и 3 отдельных момента.",
    recipientName: "Егор Дмитриевич",
    occasion: "С повышением!",
    eventDate: null,
    fromLabel: "от коллег",
    heroDescription: "Тёплые слова, яркие моменты и пожелания специально для тебя.",
    summaryTitle: "Главное поздравление",
    mainGreetingAuthorName: "Александр Сергеевич · руководитель отдела",
    mainGreeting: "Егор Дмитриевич, поздравляю Вас с повышением! Это заслуженный шаг вперёд и результат Вашей надёжности, спокойной силы, профессионализма и умения вести людей за собой. Вы умеете не только добиваться результата, но и поддерживать команду, замечать детали, брать ответственность и сохранять уважительное отношение к людям даже в напряжённые моменты. Спасибо за Вашу включённость, здравый взгляд и инициативность. Желаю вдохновения, новых побед, смелых решений и настоящего удовольствия от нового этапа.",
    privateSignature: "С благодарностью и радостью за твой новый этап — от коллег, которые рядом.",
    qualities: ["надёжный", "внимательный", "сильный", "справедливый", "вдохновляющий"],
    contributions: [
      { id: "team-message-1", authorName: "Анна", authorRole: "продакт-менеджер", message: "Егор Дмитриевич, поздравляю с повышением! Очень радостно видеть, как Ваш труд, ответственность и спокойная уверенность приводят к заслуженному результату. Желаю яркого и сильного нового этапа!" },
      { id: "team-message-2", authorName: "Михаил", authorRole: "разработчик", message: "С повышением! Спасибо за умение держать курс даже в сложные периоды и при этом оставаться внимательным к людям. Пусть впереди будет больше интересных задач, сильных решений и поводов гордиться собой." },
      { id: "team-message-3", authorName: "Ольга", authorRole: "HR", message: "Егор Дмитриевич, поздравляю! Вы один из тех людей, рядом с которыми команда чувствует опору. Желаю, чтобы новый уровень принёс не только больше возможностей, но и настоящее удовольствие от работы." },
      { id: "team-message-4", authorName: "Илья", authorRole: "аналитик", message: "Поздравляю с повышением! Пусть в новом статусе сохраняются Ваша лёгкость в общении, точность в решениях и умение видеть ситуацию шире. Желаю уверенного движения вперёд и сильной команды рядом." },
      { id: "team-message-5", authorName: "Марина", authorRole: "дизайнер", message: "Егор Дмитриевич, очень приятно поздравлять Вас с этим событием. Вы умеете сочетать требовательность, уважение и спокойствие, и это редкое качество. Пусть новый этап будет успешным, интересным и по-настоящему Вашим." },
      { id: "team-message-6", authorName: "Денис", authorRole: "руководитель проектов", message: "С повышением! Это отличный и закономерный результат Вашей работы. Желаю, чтобы впереди было много сильных идей, надёжных людей и проектов, которыми действительно хочется гордиться." },
      { id: "team-message-7", authorName: "Светлана", authorRole: "маркетолог", message: "Егор Дмитриевич, поздравляю! Спасибо за открытость, поддержку и умение говорить по делу без лишнего шума. Пусть новая роль даст ещё больше пространства для роста, влияния и профессионального удовольствия." },
      { id: "team-message-8", authorName: "Роман", authorRole: "тимлид", message: "С повышением, Егор Дмитриевич! Вы умеете не просто руководить, а задавать уверенный ритм и помогать людям собираться в сильную команду. Желаю сохранить этот стиль и только усиливать его дальше." },
      { id: "team-message-9", authorName: "Наталья", authorRole: "финансовый менеджер", message: "Поздравляю Вас с повышением! Пусть новый этап будет щедрым на хорошие результаты, уважение коллег и чувство, что всё это действительно заслужено. Спасибо за надёжность и спокойствие в работе." },
      { id: "team-message-10", authorName: "Кирилл", authorRole: "тестировщик", message: "Егор Дмитриевич, с повышением! Желаю, чтобы вместе с новым статусом пришли ещё большие возможности, интересные вызовы и люди, с которыми будет легко идти вперёд. Очень рад за Вас!" },
      { id: "team-message-11", authorName: "Алина", authorRole: "аккаунт-менеджер", message: "Поздравляю! Вы умеете сохранять ясность даже там, где все уже начинают нервничать. Это правда сильное качество. Пусть впереди будет много достойных побед, хороших решений и уверенности в каждом шаге." },
      { id: "team-message-12", authorName: "Павел", authorRole: "DevOps-инженер", message: "С повышением, Егор Дмитриевич! Спасибо за собранность, честность и умение не терять человеческий подход. Желаю, чтобы новый этап открыл для Вас ещё больше сильных проектов и правильных возможностей." },
      { id: "team-message-13", authorName: "Виктория", authorRole: "контент-менеджер", message: "Егор Дмитриевич, поздравляю с новым этапом! Пусть работа приносит не только высокий результат, но и радость, вдохновение и ощущение, что Вы на своём месте. Это действительно заслуженное повышение." },
      { id: "team-message-14", authorName: "Артём", authorRole: "разработчик", message: "С повышением! Желаю, чтобы новая роль была не только про ответственность, но и про свободу принимать сильные решения, двигать идеи вперёд и собирать вокруг себя людей, с которыми хочется работать." },
      { id: "team-message-15", authorName: "Елена", authorRole: "юрист", message: "Поздравляю Вас, Егор Дмитриевич! Очень ценно, что Вы умеете быть внимательным, корректным и при этом твёрдым в важных вопросах. Пусть впереди будет много профессионального уважения и больших успехов." },
      { id: "team-message-16", authorName: "Сергей", authorRole: "менеджер по продажам", message: "С повышением! Это тот случай, когда новость вызывает только искреннюю радость. Желаю энергии, точных решений, уверенного роста и ощущения, что впереди действительно начинается очень хороший этап." },
      { id: "team-message-17", authorName: "Татьяна", authorRole: "офис-менеджер", message: "Егор Дмитриевич, поздравляю! Спасибо за уважительное отношение, спокойствие и умение слышать людей. Пусть новая ступень откроет больше интересных задач, достойных побед и тёплых рабочих дней." },
      { id: "team-message-18", authorName: "Дмитрий", authorRole: "системный аналитик", message: "С повышением, Егор Дмитриевич! Пусть новый этап будет про сильные команды, ясные цели и решения, которыми можно гордиться. Спасибо за надёжность и за то, что рядом с Вами работать спокойно." },
      { id: "team-message-19", authorName: "Юлия", authorRole: "PR-менеджер", message: "Поздравляю с повышением! Желаю, чтобы впереди было много ярких профессиональных моментов, смелых идей и честного признания Вашей работы. Очень приятно видеть такой заслуженный рост." },
      { id: "team-message-20", authorName: "Команда отдела", message: "Егор Дмитриевич, поздравляем с повышением! Мы рады, что именно Вы выходите на новый уровень, потому что в Вас сочетаются профессионализм, человечность и умение вести за собой. Пусть впереди будет ещё больше сильных достижений!" }
    ],
    quoteCandidates: [
      { id: "team-quote-1", text: "Рядом с Вами команда чувствует опору." },
      { id: "team-quote-2", text: "Вы умеете не просто руководить, а задавать уверенный ритм." },
      { id: "team-quote-3", text: "Это заслуженный шаг вперёд и результат Вашей работы." }
    ],
    organizerQuoteIds: ["team-quote-1", "team-quote-2", "team-quote-3"],
    recipientQuoteIds: ["team-quote-1", "team-quote-2", "team-quote-3"],
    photos: [
      { id: "team-photo-discussion", src: "/examples/team-editorial/project-discussion.jpg", width: 1536, height: 1024, caption: "Разговоры, из которых рождаются решения", crop: { x: 0.5, y: 0.5, zoom: 1 } },
      { id: "team-photo-evening", src: "/examples/team-editorial/team-evening.jpg", width: 1536, height: 1024, caption: "Когда работа превращается в общее дело", crop: { x: 0.5, y: 0.5, zoom: 1 } },
      { id: "team-photo-horizons", src: "/examples/team-editorial/new-horizons.jpg", width: 1536, height: 1024, caption: "Новые горизонты начинаются именно так", crop: { x: 0.5, y: 0.5, zoom: 1 } },
      { id: "team-photo-energy", src: "/examples/team-editorial/team-energy.jpg", width: 1536, height: 1024, caption: "Команда, с которой хочется идти дальше", crop: { x: 0.5, y: 0.5, zoom: 1 } },
      { id: "team-photo-path", src: "/examples/team-editorial/shared-path.jpg", width: 1536, height: 1024, caption: "Маленький путь к большому новому этапу", crop: { x: 0.5, y: 0.5, zoom: 1 } },
      { id: "team-photo-good-news", src: "/examples/team-editorial/good-news.jpg", width: 1536, height: 1024, caption: "Хорошие новости приятнее делить вместе", crop: { x: 0.5, y: 0.5, zoom: 1 } }
    ],
    memoryPhotoIds: ["team-photo-energy", "team-photo-path", "team-photo-good-news"],
    memoryTitle: "Моменты, которые хочется сохранить",
    memoryDescription: "Команда, общий путь и хорошие новости, которые особенно приятно делить вместе."
  },
  "text-stress": {
    id: "text-stress",
