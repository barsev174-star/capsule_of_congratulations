...
export const createCardDraft = async (input: CreateCardInput): Promise<CreateCardResult> => {
  ...
  const card: CardDraft = {
    ...
    paidAt: null,
    collectionOpenedAt: null,
    collectionClosedAt: null,
    deliveredAt: null,
    recipientFirstOpenedAt: null,
    refundedAt: null,
    revokedAt: null,
    isHidden: false,
    hiddenAt: null,
    ...
    activeAccessGrantId: null,
    repurchaseAllowedAt: null,
    repurchaseExpiresAt: null,
    repurchaseUsedAt: null,
    repurchaseAllowedByAdminId: null,
    deletedAt: null,
    purgeAt: null,
    createdAt: now,
    updatedAt: now
