...
const defaultFaqs = [
  ["Нужна ли регистрация?", "Начать открытку можно без регистрации. Перед приглашением участников организатор подтверждает email, чтобы сохранить доступ и возвращаться к открытке с любого устройства. Пароль не нужен. Участникам регистрация не требуется."],
