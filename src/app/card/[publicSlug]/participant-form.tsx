...
export const ParticipantForm = ({ cardId, publicSlug }: Props) => {
  ...
  return (
    <section className={styles.formCard}>
      ...
      <p className={styles.hint}>
        Сейчас работает ручное добавление текста. AI-помощник подключим следующим блоком.
      </p>
      ...
      >
        ...
        <div className={styles.field}>
          ...
          <textarea
            id="message"
            name="message"
            placeholder="Напишите несколько теплых слов. Ссылки и рекламный текст пока не поддерживаются."
            required
          />
        </div>
        ...
        <div className={styles.actions}>
          ...
          <button type="button" className={styles.aiButton} disabled>
            AI-помощник скоро
          </button>
        </div>
      </form>
