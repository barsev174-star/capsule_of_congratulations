...
13 августа добавлены ещё два мастер-атласа. Из первого скрипт воспроизводимо собирает семь разных подложек смысловых блоков и четыре циклические подложки поздравлений. Из второго — заметную художественную кожу фоторамок; окно фотографии и область подписи при этом вырезаются строго по preset-геометрии.
