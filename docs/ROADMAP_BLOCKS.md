...
6. затем устойчивое хранение, деплой, AI и оплата.

AI, регистрация, оплата и полноценная админка пока не являются ближайшим блоком.
