...
7. В Яндекс Вебмастере сайт подтверждён, ошибок и рекомендаций нет, sitemap уже находится в обработке. Форма приоритетного переобхода четырёх SEO-страниц подготовлена, но не отправлена без подтверждения владельца. В Google Search Console ресурс отсутствует; его создание также ожидает подтверждения и может потребовать отдельной проверки владения. Еженедельная автоматизация `slovesto` активна: понедельник, 10:00.
