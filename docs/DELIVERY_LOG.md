...
## Update 2026-08-02 Manager Tabs, Photo Slots And Gift Poll Release Candidate
...
8. Production deployment на `168.222.141.120` выполняется после публикации release commit; фактический commit и результат health-check фиксируются отдельной записью после выкладки.
