...
4. Системное действие «Поделиться открыткой» передаёт только заголовок и URL. Дополнительная фраза «Близкие люди…» удалена, чтобы Telegram и другие приложения самостоятельно формировали карточку ссылки.
