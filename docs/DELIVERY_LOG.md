...
9. Страница участника и форма добавления поздравления.
10. AI-помощник поздравлений.
11. Панель организатора.
12. Оплата и публикация.
...
3. Что именно хотим включить в первый ручной тест после блока создания открытки.
