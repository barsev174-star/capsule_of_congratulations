...
5. Визуально проверены три продуктовых шаблона; общий runtime не содержит веток конкретного universal-шаблона. Полный прогон: 768 тестов прошли, 10 пропущены.
