...
7. Новая фотография по-прежнему занимает первый свободный слот, а перенос и обмен фотографий сохраняются.
...
5. Перенос в свободную позицию и обмен двух занятых позиций сохраняются после reload; на desktop фото переносится drag-and-drop, на mobile — через пункт «Переместить» в меню троеточия.
